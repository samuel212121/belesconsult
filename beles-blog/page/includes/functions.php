<?php
/**
 * Beles Consulting Blog — Shared Functions
 * Reusable queries used by blog.php, post.php, and the admin panel.
 */
...
/** Get paginated, published posts — optionally filtered by category slug */
